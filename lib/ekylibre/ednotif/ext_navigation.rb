module Ekylibre
  module Ednotif
    class ExtNavigation
      ...
      attr_reader :ednotif_navigation_tree, :new_navigation_tree,
                  :ednotif_xml_navigation_childrens

      def initialize
        @ednotif_navigation_tree = Ekylibre::Navigation::Tree
                                      .load_file(ednotif_navigation_file_path,
                                                 :navigation,
                                                 %i[part group item])
      ...
      def build_new_tree
        @ednotif_navigation_tree.children.each do |part|
