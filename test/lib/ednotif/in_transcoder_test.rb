...
module Ednotif
  class InTranscoderTest < ActiveSupport::TestCase
    setup do
    ...
    test 'convert hash response from savon to ekylibre response on a get list operation example' do
      savon_hashed_response = {
        ...
        bovins: { bovin: [{ identite_bovin: { bovin: { code_pays: 'FR', numero_national: '7599882110' },
                                              ...
                                              statut_filie: false,
                                              mere_porteuse: { bovin: { code_pays: 'FR', numero_national: '7599881110' },
type_racial: '34' },
                            ...
                            periodes_presences: { periode_presence: { entree: { date_entree: Date.parse('Sat, 01 Feb 2014'),
  cause_entree: 'N' } } } },
                          { identite_bovin: { bovin: { code_pays: 'FR', numero_national: '7599881110' },
                                              ...
                                              nom_bovin: 'RESINE',
                                              statut_filie: false,
                                              mere_porteuse: { bovin: { code_pays: 'FR', numero_national: '7599881199' },
type_racial: '34' },
                                              pere_ipg: { bovin: { code_pays: 'FR', numero_national: '7599880198' }, type_racial: '34' },
                                              exploitation_naissance: { code_pays: 'FR', numero_exploitation: '75998877' } },
                            periodes_presences: { periode_presence: [
  { entree: { date_entree: Date.parse('Tue, 18 May 2010'), cause_entree: 'N' },
  sortie: { date_sortie: Date.parse('Thu, 21 Jul 2011'),
cause_sortie: 'H' } }, { entree: { date_entree: Date.parse('Fri, 30 Sep 2011'), cause_entree: 'P' } }
  ] } },
                          { identite_bovin: { bovin: { code_pays: 'FR', numero_national: '7599880110' },
                                              ...
                                              nom_bovin: 'HERMES',
                                              statut_filie: false,
                                              mere_porteuse: { bovin: { code_pays: 'FR', numero_national: '7599889910' },
type_racial: '34' },
                            ...
                            periodes_presences: { periode_presence: { entree: { date_entree: Date.parse('Tue, 12 Jun 2012'),
  cause_entree: 'A' } } } }] },
      ...
      expected_ekylibre_response = {
        ...
        animals: [{ identity: { country_code: 'fr',
                  ...
                  { identity: { country_code: 'fr',
                                ...
                                farm_number: '75998877' },
                    mouvements: [
                      { entry: { entry_date: Date.parse('Tue, 18 May 2010'), entry_reason: 'birth' },
  exit: { exit_date: Date.parse('Thu, 21 Jul 2011'), exit_reason: 'loan' } },
